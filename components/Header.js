    ...
    return (
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5">
            ...
            <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
                ...
                className="flex-grow pl-5 bg-transparent outline-none text-sm text-gray-600 placholder-gray-400" type="text" placeholder={placeholder || "Start your search"} />
                <SearchIcon 
            ...
            {SearchInput && (<div className="flex flex-col col-span-3 mx-auto">
                ...
                <div className="flex items-center border-b mb-4">
                    ...
                    min={1}
                    type="number" className="w-12 pl-2 outline-none text-red-400" />
                </div>
                <div className="flex ">
                    <button onClick={resetInput} className="flex-grow">Cancel</button>
                    <button  onClick={search}
                    className="flex-grow">Search</button>
                </div>
            </div>) }
